package com.x.quartz.web.controller;

import java.io.IOException;
import java.util.List;
import java.util.Map;

import com.x.quartz.service.JobService;
...
import com.x.quartz.job.SpringJobBeanFactory;
...
public class QuartzController implements InitializingBean {
	...
	public ModelAndView findAll() {
		...
		mv.addObject("jobNameList", SpringJobBeanFactory.getJobNameList());
		return mv;
	}
